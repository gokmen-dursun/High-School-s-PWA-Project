...
- **GitHub** — *Every commit is tracked and it's full transparency on the build journey. I don't wanna use AI to make this app.*
...
### the AuRA grant 
The Auvergne-Rhône-Alpes region funds young entrepreneurs up to 2 000 € and this project is exactly what it targets: local, educational, built by a minor, with real social impact. It also adds serious credibility to an Ivy League application.
